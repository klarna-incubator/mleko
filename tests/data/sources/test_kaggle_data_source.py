"""Test suite for the `data.sources.kaggle_data_source` module."""
...
from mleko.data.sources.kaggle_data_source import KaggleCredentials, KaggleCredentialsManager, KaggleFileMetadata


class TestKaggleCredentials:
    """Test suite for `data.sources.kaggle_data_source.KaggleCredentials`."""
...
class TestCredentialsManager:
    """Test suite for `data.sources.kaggle_data_source.TestCredentialsManager`."""
    ...
    def test_fallback_to_default_path(self):
        ...
        with patch.dict(os.environ, {"KAGGLE_USERNAME": "", "KAGGLE_KEY": ""}):
            with patch(
                "mleko.data.sources.kaggle_data_source.KaggleCredentialsManager._read_environment_config"
            ) as mock_read_env_config, patch(
                "mleko.data.sources.kaggle_data_source.KaggleCredentialsManager._read_config_file"
...
class TestKaggleFileMetadata:
    """Test suite for `data.sources.kaggle_data_source.KaggleFileMetadata`."""
...
class TestKaggleDataSource:
    """Test suite for `data.sources.kaggle_data_source.KaggleDataSource`."""
    ...
    @patch("mleko.data.sources.kaggle_data_source.KaggleCredentialsManager.get_kaggle_credentials")
    ...
    @patch("mleko.data.sources.kaggle_data_source.KaggleCredentialsManager.get_kaggle_credentials")
    @patch("mleko.data.sources.kaggle_data_source.KaggleDataSource._kaggle_fetch_files")
