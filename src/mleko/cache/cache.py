...
class LRUCacheMixin(CacheMixin):
    ...
    def _load_cache_from_disk(self) -> None:
        ...
        Cache entries are ordered by their last access time, and the cache is trimmed if needed.
        """
        cache_files = [
            f
        ...
        ordered_cache_files = sorted(cache_files, key=lambda x: x.stat().st_atime)
